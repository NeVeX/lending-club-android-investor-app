package com.mark.lendingclub.invest.util;
...
public class UIUtil {
    ...
    static
    {
        ...
        DECIMAL_FORMAT_NO_FRACTIONAL.setMultiplier(1);
        DECIMAL_FORMAT_NO_FRACTIONAL.setMultiplier(1);
        DECIMAL_FORMAT_CONDENSED.setMultiplier(1);
        DECIMAL_FORMAT_CONDENSED_NO_FRACTIONAL.setMultiplier(1);
    ...
    {
        double percentValue = d / 100;
        if ( includeFractional) {
            return PERCENT_FORMAT.format(percentValue);
        }
        return PERCENT_FORMAT_NO_FRACTIONAL.format(percentValue);
    }
    ...
    public static Integer getResourceColorIdBasedOnProsperRating(String prosperRating) {
        if ( prosperRating != null )
        {
            ...
            {
                case "A": return R.color.prosper_rating_aa_bg;
                case "B":  return R.color.prosper_rating_a_bg;
                case "C":  return R.color.prosper_rating_b_bg;
                case "D":  return R.color.prosper_rating_c_bg;
                case "E":  return R.color.prosper_rating_d_bg;
                case "F":  return R.color.prosper_rating_e_bg;
                case "G": return R.color.prosper_rating_hr_bg;
            }
         }
        return null;
    }
